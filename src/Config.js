...
const Config = new function() {
    ...
    /**
     * The amount of decimal places your coin has, e.g. Qbit has two
     * decimals
     */
     ...
     * In Qbit, this converts to QBC
     */
    this.addressPrefix = 18314;
    ...
    /**
     * Your coins 'ticker', generally used to refer to the coin, i.e. QBC...
     */
    this.ticker = 'QBC';
     ...
     *
     */
    this.repoLink = 'https://t.me/Qbitcurrency';

    /**
     * This only controls the name in the settings screen.
     */
    this.appName = 'Qbit Silver ';

    /**
     * Slogan phrase during wallet CreateScreen
     */
    this.sloganCreateScreen = 'Qbit Secure Payments.';
     ...
     */
    this.explorerBaseURL = 'https://qbitblockexplorer.com/?search=';
